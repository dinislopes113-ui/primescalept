  ...
  const services = [
    {
      ...
      icon: Target,
      color: 'blue',
      prompt: 'High quality photography of a modern, minimalist office desk with a subtle glowing lamp. Soft natural lighting, shallow depth of field, blurred background. STRICTLY NO TEXT, NO letters, NO numbers, NO people, NO screens. Purely decorative, clean, and simple professional atmosphere.'
    },
    {
      id: 'social',
      ...
      icon: Users,
      color: 'indigo',
      prompt: 'High quality photography of a modern, minimalist office lounge area with a sleek coffee table. Soft natural lighting, shallow depth of field, blurred background. STRICTLY NO TEXT, NO letters, NO numbers, NO people, NO screens. Purely decorative, clean, and simple professional atmosphere.'
    },
    {
      id: 'strategy',
      ...
      icon: BarChart3,
      color: 'emerald',
      prompt: 'High quality photography of a modern, minimalist meeting room table with a closed elegant notebook. Soft natural lighting, shallow depth of field, blurred background. STRICTLY NO TEXT, NO letters, NO numbers, NO people, NO screens. Purely decorative, clean, and simple professional atmosphere.'
    },
    {
      id: 'leads',
      ...
      icon: Megaphone,
      color: 'orange',
      prompt: 'High quality photography of a modern, minimalist office reception area with a sleek indoor plant. Soft natural lighting, shallow depth of field, blurred background. STRICTLY NO TEXT, NO letters, NO numbers, NO people, NO screens. Purely decorative, clean, and simple professional atmosphere.'
    },
    {
      id: 'web',
      ...
      icon: LayoutTemplate,
      color: 'slate',
      prompt: 'High quality photography of a modern, minimalist clean workspace with a closed sleek laptop. Soft natural lighting, shallow depth of field, blurred background. STRICTLY NO TEXT, NO letters, NO numbers, NO people, NO screens. Purely decorative, clean, and simple professional atmosphere.'
    }
  ];
